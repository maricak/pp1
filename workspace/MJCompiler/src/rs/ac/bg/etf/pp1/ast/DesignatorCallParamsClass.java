...
public class DesignatorCallParamsClass extends DesignatorCallParams {

    private OptionalActPars OptionalActPars;

    public DesignatorCallParamsClass (OptionalActPars OptionalActPars) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorCallParamsClass(\n");
