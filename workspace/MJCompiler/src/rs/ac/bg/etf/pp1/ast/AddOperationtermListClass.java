...
public class AddOperationtermListClass extends AddopTermList {

    private AddopTermList AddopTermList;
    private Addop Addop;
    private Term Term;

    public AddOperationtermListClass (AddopTermList AddopTermList, Addop Addop, Term Term) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("AddOperationtermListClass(\n");
