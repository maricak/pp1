...
public class MulOperationFactorListClass extends MulopFactorList {

    private MulopFactorList MulopFactorList;
    private Mulop Mulop;
    private Factor Factor;

    public MulOperationFactorListClass (MulopFactorList MulopFactorList, Mulop Mulop, Factor Factor) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MulOperationFactorListClass(\n");
