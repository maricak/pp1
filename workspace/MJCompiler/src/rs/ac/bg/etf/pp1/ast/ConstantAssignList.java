...
public class ConstantAssignList extends ConstAssignList {

    private ConstAssignList ConstAssignList;
    private ConstAssign ConstAssign;

    public ConstantAssignList (ConstAssignList ConstAssignList, ConstAssign ConstAssign) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstantAssignList(\n");
