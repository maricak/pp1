...
public class ForStatementClass extends ForStatement {
    ...
    public ForStatementClass (OptionalDesignatorStatement OptionalDesignatorStatement, OptionalCondition OptionalCondition, OptionalDesignatorStatement OptionalDesignatorStatement1, Statement Statement) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ForStatementClass(\n");
