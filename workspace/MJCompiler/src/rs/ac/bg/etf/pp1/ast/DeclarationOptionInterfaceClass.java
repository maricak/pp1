...
public class DeclarationOptionInterfaceClass extends DeclOption {

    private InterfaceDecl InterfaceDecl;

    public DeclarationOptionInterfaceClass (InterfaceDecl InterfaceDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DeclarationOptionInterfaceClass(\n");
