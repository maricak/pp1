...
public class DesignatorStandardFunction extends DesignatorStatement {

    private StandardFunction StandardFunction;

    public DesignatorStandardFunction (StandardFunction StandardFunction) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStandardFunction(\n");
